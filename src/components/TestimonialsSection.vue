                        ...
                        <div
                            ...
                            <div class="w-full flex mb-4 items-center">
                                <div class="overflow-hidden rounded-full w-10 h-10 bg-gray-50 border border-gray-200">
                                    <img :src="element.image" alt="testimonials image" loading="lazy">
                                </div>
...
const testimonials = ref([
    {
        id: 1,
        fullName: 'client 1',
        image: 'src/assets/user1.webp',
        comment: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ullam nulla eaque placeat animi incidunt expedita eos aspernatur ad, odit beatae.'
    },
    {
        id: 2,
        fullName: 'client 2',
