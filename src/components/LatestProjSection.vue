                ...
                <div v-for="project in filteredProjects" :key="project.id">
                        ...
                        <div
                            ...
                            <a class="h-14 w-14 mr-2 border-2 relative rounded-full border-[#ADB7BE] hover:border-white group/link"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    class="h-10 w-10 text-[#ADB7BE] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 cursor-pointer">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.43">
                                    </path>
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M15 12a3 3 0 1 1-6 0 3 3 0 1 6 0Z">
                                    </path>
                                </svg>
                            </a>
                        </div>
                    ...
                    <div class="text-white rounded-b-xl mt-3 bg-[#111a3e] shadow-lg border border-[#1f1641] py-6 px-4 ">
                        ...
                        <div class="flex flex-wrap p-2.5">
                            <div v-for="techonology in project.technologies" :key="techonology"
                                ...
                                <p class="px-1 py-2">{{ techonology }}</p>
                            </div>
                        </div>
                    </div>
                </div>
...
const Projects = ref([
    {
        ...
        title: "Project 1",
        description:
            "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Temporibus at quo officia sapiente quas vel, optio ex iste ad? Animi hic blanditiis officia laborum cum laboriosam fugiat autem qui dolore.",
