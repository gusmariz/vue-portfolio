    ...
    >
        ...
        <div class="space-y-8 py-8">
          ...
          >
            ...
            <div class="w-3/4 pl-4">
              <h3
                class="text-2xl semi-bold uppercase text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary lg:text-xl"
              >
                {{ element.School }}
              </h3>
      ...
      >
        ...
        <p class="text-base lg:text-lg mt-8 py-8">
          ...
          eligendi iusto, alias ipsum impedit ullam perspiciatis fugiat adipisci
          ipsa, consequuntur fuga cumque, veniam inventore earum! Autem veniam
          libero, voluptatem velit, expedita similique nostrum pariatur hic vero
          magnam saepe accusamus. Fuga explicabo pariatur magnam. Inventore
          doloremque iure modi et nulla.
        </p>
