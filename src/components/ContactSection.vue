<template>
    <section class="text-white mt-20" id="contact">
        ...
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div class="">
                <p class="text-[#adb7be]">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis, sed excepturi
                    fugiat, aut eligendi aperiam saepe doloremque nobis perferendis magni quidem at. Soluta voluptatibus
                    quas mollitia obcaecati dolor beatae odit, quibusdam totam consequatur sequi id impedit. Iure
                    aspernatur blanditiis repellendus.</p>
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>LinkedIn</h4>
                            <p>www.LinkedIn.com/xxxxxxxxx</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-tr opacity-25 from-[#570cac] to-primary blur-2xl h-20 w-80 z-0 absolute
                -top-1/2 -left-4 transform -translate-x-2/3 -translate-1/2">
            </div>
        </div>
    </section>
</template>
